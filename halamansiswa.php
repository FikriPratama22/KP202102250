...
<body>
    <nav class="navbar fixed-top bg-success">
		<div class="container-fluid">
		  <a class="navbar-brand  text-light" href="halamansiswa.php">
      ...
      <p class="lead">Halaman Calon Siswa Baru MTSN 01 Mempawah Hilir</p>
 ...
 <section>
    <div class="row justify-content-center">
        <div class="col-md-4 mb-3">
            ...
            <img src="img/Pendaftaran.jpg" class="card-img-top" alt="..." />
              <div class="card-body">
                <h5 class="card-title">Daftar Sekarang!</h5>
                <p class="card-text">Halaman Untuk Mengisi Form Pendaftaran Peserta Didik Baru</p>
                <a href="kelolasiswa.php" class="btn btn-success" data-aos="zoom-in">Daftar</a>
              </div>
            </div>
        </div>
    </div>    
